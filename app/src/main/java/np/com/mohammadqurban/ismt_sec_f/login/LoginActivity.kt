package np.com.mohammadqurban.ismt_sec_f.login
...
import np.com.mohammadqurban.ismt_sec_f.dashboard.DashboardActivity
...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnLogin.setOnClickListener {
            ...
            {
                Toast.makeText(this, "plesae enter a valid email", Toast.LENGTH_SHORT).show()
            }
