...
import np.com.mohammadqurban.ismt_sec_f.BitmapScalar
import np.com.mohammadqurban.ismt_sec_f.GeoCoding
import np.com.mohammadqurban.ismt_sec_f.R
import np.com.mohammadqurban.ismt_sec_f.databinding.ActivityAddOrUpdateItemBinding
...
class AddOrUpdateItemActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        addOrUpdateItemBinding.mbSubmit.setOnClickListener {
            ...
            {
                Toast.makeText(this, "Please fill up the required field", Toast.LENGTH_SHORT).show()
            }
            ...
            else
            {
                ...
                Thread {
                    try {
                        ...
                        runOnUiThread {
                            clearFieldsData()
                            showToast("Products detail added or updated...")
